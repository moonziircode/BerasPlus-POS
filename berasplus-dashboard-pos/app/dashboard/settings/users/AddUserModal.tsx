...
import { UserPlus, X, Loader2, User, Mail, Lock, Shield, Building, ShieldAlert } from 'lucide-react'
...
export default function AddUserModal({ stores }: { stores: Store[] }) {
  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-emerald-700 active:scale-95 dark:bg-emerald-600 dark:hover:bg-emerald-500"
      >
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Buat akses login untuk staf baru
                  </p>
                </div>
              </div>
              <button
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    placeholder="budi@berasplus.com"
                    className="block w-full rounded-lg border border-zinc-200 bg-zinc-50 py-2.5 pl-10 pr-3 text-sm text-zinc-900 placeholder-zinc-400 transition-all focus:border-emerald-500 focus:bg-white focus:outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:placeholder-zinc-500 dark:focus:border-emerald-500 dark:focus:bg-zinc-900"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    placeholder="Kosongkan untuk default: Berasplus123!"
                    className="block w-full rounded-lg border border-zinc-200 bg-zinc-50 py-2.5 pl-10 pr-3 text-sm text-zinc-900 placeholder-zinc-400 transition-all focus:border-emerald-500 focus:bg-white focus:outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:placeholder-zinc-500 dark:focus:border-emerald-500 dark:focus:bg-zinc-900"
                  />
                </div>
              </div>
