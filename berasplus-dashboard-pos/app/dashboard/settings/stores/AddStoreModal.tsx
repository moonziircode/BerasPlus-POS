...
import { Plus, X, Loader2, Store, MapPin, Phone, ShieldAlert } from 'lucide-react'
...
export default function AddStoreModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.message || 'Gagal menambahkan cabang toko baru.')
    } finally {
      setLoading(false)
    }
  }
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Masukkan detail cabang toko baru Anda
                  </p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    type="text"
                    required
                    placeholder="Contoh: Cabang Margonda Depok"
                    value={name}
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    type="text"
                    placeholder="Contoh: 021-778899 (Opsional)"
                    value={phone}
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <textarea
                    placeholder="Contoh: Jl. Raya Margonda No. 12, Kota Depok"
                    value={address}
