...
export default function AddRawMaterialModal({ categories }: AddRawMaterialModalProps) {
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Daftarkan stok bahan mentah (gabah/beras curah) untuk produksi
                  </p>
                </div>
              </div>
              <button
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    type="text"
                    required
                    placeholder="Contoh: Beras IR64 Curah (Sack 50Kg)"
                    value={name}
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    step="0.0001"
                    required
                    placeholder="Contoh: 50.0000 (jika 1 unit = 50 Kg)"
                ...
                <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                  Berapa berat bersih (Kg) per 1 unit satuan terkecil produk ini.
                </p>
              </div>
